...
@Component//these are bean. they are singleton by default,@Controller,@Service,@Repository,@Configuration
public class TwitterKafkaStatusListener extends StatusAdapter {
    ...
    private final com.microservices.demo.kafka.producer.config.service.KafkaProducer<Long, TwitterAvroModel> kafkaProducer;
